...
public class EditActivity extends AppCompatActivity {
    ...
    private void pessoaToTela() {
        tId.setText(Integer.toString(pessoa.getId()));   tNome.setText(pessoa.getNome());
        tCpf.setText(pessoa.getCpf());
    }
    private void telaToPessoa() {
        pessoa.setId(Integer.parseInt(tId.getText().toString()));   pessoa.setNome(tNome.getText().toString());   pessoa.setCpf(tCpf.getText().toString());   }
}
